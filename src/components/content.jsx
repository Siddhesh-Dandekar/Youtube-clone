...
function Content(props) {
    ...
    return (
        <> <Link to={`/watch/${_id}`}>
            <div className="p-2">
                <div>
                    <img className="rounded-xl" src={thumbnailUrl} alt="" />
                </div>
                <div className="flex my-2">
                    ...
                    <div className="pl-3 flex-1 leading-none">
                        <h6 className=" font-semibold text-sm leading-normal">{title}</h6>
                        ...
                        <span className="text-xs text-gray-500  font-medium">{views} views • 2 hour ago</span>
                    </div>
