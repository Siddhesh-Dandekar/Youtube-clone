            ...
            <div className="w-full lg:w-5/6 mt-2 px-3 lg:px-0 lg:ml-6 lg:mr-2 flex flex-col gap-3">
                ...
                <div className="flex justify-between">
                    <div className="flex gap-4">
                        ...
                        {UserInfo._id == videoData.userId ? <button className="text-white text-sm font-medium bg-black px-4 rounded-3xl">View Channel</button> : <button className="text-white text-sm font-medium bg-black px-4 rounded-3xl">Subscribe</button>}
