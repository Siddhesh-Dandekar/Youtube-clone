...
function Channel() {
        ...
        <div className="flex w-full gap-2">
            ...
            <div className="flex flex-col justify-center gap-3 ml-2">
                ...
                <span className=" text-xs text-gray-600">More about this channel
                    ...more</span>
                {channelDetails.userId == UserInfo._id ? <Link to="/channel/studio"><button className="w-fit bg-gray-200 font-semibold text-sm py-2 px-4 rounded-full">Customize Channel</button></Link> : <button className="w-fit bg-black text-sm text-white py-2 px-4 rounded-full">Subscribe</button>}
    ...
    </div> : <main className="flex w-full pt-14 ">
